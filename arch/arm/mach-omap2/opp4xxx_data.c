...
#define OMAP4460_VDD_MPU_OPP50_UV		1000000
...
#define OMAP4460_VDD_MPU_OPPNITRO1_UV		1388000
#define OMAP4460_VDD_MPU_OPPOVERCLOCK_UV	1395000
#define OMAP4460_VDD_MPU_OPPOVERCLOCK2_UV	1400000
#define OMAP4460_VDD_MPU_OPPOVERCLOCK3_UV	1405000
...
struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO1_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPOVERCLOCK_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPOVERCLOCK2_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
        VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPOVERCLOCK3_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
static struct omap_vdd_dep_volt omap446x_vdd_mpu_core_dep_data[] = {
	...
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPNITRO1_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
        {.main_vdd_volt = OMAP4460_VDD_MPU_OPPOVERCLOCK_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
        {.main_vdd_volt = OMAP4460_VDD_MPU_OPPOVERCLOCK2_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
        {.main_vdd_volt = OMAP4460_VDD_MPU_OPPOVERCLOCK3_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
};
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	/* MPU OPP1 - OPP50 */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 300000000, OMAP4460_VDD_MPU_OPP50_UV),
	/* MPU OPP2 - OPP100 */
	...
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1300000000, OMAP4460_VDD_MPU_OPPNITRO1_UV),
	/* MPU OPP4 - OPP-Nitro SpeedBin */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1350000000, OMAP4460_VDD_MPU_OPPOVERCLOCK_UV),
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1400000000, OMAP4460_VDD_MPU_OPPOVERCLOCK2_UV),
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1420000000, OMAP4460_VDD_MPU_OPPOVERCLOCK3_UV),
	/* L3 OPP1 - OPP50 */
	...
	/* SGX OPP2 - OPP100 */
	OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 307000000, OMAP4460_VDD_CORE_OPP100_UV),
	/* SGX OPP3 - OPPOV */
